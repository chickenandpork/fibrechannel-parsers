\doxyref{Virtual\+Wisdom3 -\/style 4-\/column format}{p.}{Alias4Parser}
...
\doxyref{Virtual\+Wisdom3 -\/style 2-\/column format}{p.}{NicknameParser}
...
\doxyref{Virtual\+Wisdom4 Validation Errors}{p.}{VW4InvalidAdded} \section{Virtual\+Wisdom3 -\/style 4-\/column format}\label{Alias4Parser}
The \doxyref{Alias4\+Parser}{p.}{classorg_1_1smallfoot_1_1parser_1_1zone_1_1Alias4Parser} interprets a 4-\/column C\+S\+V as though it contains \char`\"{}\+W\+W\+N\char`\"{}, W\+W\+P\+N, Alias, Type For example\+:

\begin{DoxyVerb}"WWN",c050761234567890,AIXLeftBig,Server
"WWN",10000000c9123456,CustServer,Server
"WWN",50060e801234567f,HDS0123457_CL7F,Storage
\end{DoxyVerb}


This collector/parser chain is slightly more successful than text-\/based parsers due to proper interpretation of M\+S-\/\+D\+O\+S \char`\"{}\+I'm the exception\char`\"{} line-\/ending markers. \section{Brocade \char`\"{}alishow\char`\"{} and \char`\"{}zoneshow\char`\"{}}\label{AliShowZoneParser}
...
This collector/parser chain is more successful than text-\/based parsers simply because it avoids human-\/error and the error of not reading the warning to avoid putty log traces and other \char`\"{}nearly 100\% unmodified\char`\"{} methods of transferring content. Additionally, this is an entirely binary connection, so the user cannot accidentally edit the content. Finally, as B\+N\+A may harvest from and provide config to many fabrics at once, this is typically \char`\"{}a broader net to cast\char`\"{} to collect information. \section{Virtual\+Wisdom3 -\/style 2-\/column format}\label{NicknameParser}
The \doxyref{Nickname\+Parser}{p.}{classorg_1_1smallfoot_1_1parser_1_1zone_1_1NicknameParser} interprets a 2-\/column C\+S\+V as though it contains W\+W\+P\+N, Alias For example\+:

\begin{DoxyVerb}c050761234567890,AIXLeftBig
10000000c9123456,CustServer
50060e801234567f,HDS0123457_CL7F
\end{DoxyVerb}


Additionally, this parser can be used to pull data from any C\+S\+V; for example, if your C\+S\+V has more than just W\+W\+P\+N/\+Nickname (which is typical when pulled from another resource), you might have\+:\begin{DoxyVerb}BusinessUnit, Server, WWPN, CapEx Code, Location
Billing, BillingBigBox, c050761122334455, 2013A4, Houston
CustServ, Service44, 1000001b32123456, 2013A4, Dallas
\end{DoxyVerb}


You can use system-\/wide parameters or file-\/specific parameters to set a different column number (see the jvmopt \char`\"{}wwn\char`\"{}, \char`\"{}nickname\char`\"{})


\begin{DoxyCode}
java -D wwn=4 -jar fcparser.jar -N cisco.txt ...  
\end{DoxyCode}
 
\begin{DoxyCode}
java -D wwn=4 -D nickname=0 -jar fcparser.jar -N cisco.txt ...  
\end{DoxyCode}
...
\begin{DoxyCode}
java -jar fcparser.jar -N \textcolor{stringliteral}{"cisco.txt;wwn=4"} ...  
\end{DoxyCode}
 
\begin{DoxyCode}
java -jar fcparser.jar -N \textcolor{stringliteral}{"cisco.txt;wwn=4;nickname=0"} ...  
\end{DoxyCode}


This collector/parser chain is slightly more successful than text-\/based parsers due to proper interpretation of M\+S-\/\+D\+O\+S \char`\"{}\+I'm the exception\char`\"{} line-\/ending markers. \section{Net\+App O\+C\+I back-\/end Database (osmsql)}\label{OSMURLConnection}
