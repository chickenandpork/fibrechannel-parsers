...
10000000c9444431,"NASMany_654321" \end{DoxyVerb}
 \section{Brocade B\+N\+A Database}\label{BNAPURLConnection}
...
or \begin{DoxyVerb}java -jar vw4tools.jar -N bna://bna.example.com/\end{DoxyVerb}
 \section{Cisco D\+C\+N\+M Database}\label{DCNMURLConnection}
The \doxyref{D\+C\+N\+M\+U\+R\+L\+Connection}{p.}{classorg_1_1smallfoot_1_1parser_1_1dcnmsql_1_1DCNMURLConnection} collects dcnm\+:// and dcnmsql\+:// sources from D\+C\+N\+M's backend database to search for aliases it may know

This collector/parser chain is more successful than text-\/based parsers simply because it avoids human-\/error and the error of not reading the warning to avoid putty log traces and other \char`\"{}nearly 100\% unmodified\char`\"{} methods of transferring content. Additionally, this is an entirely binary connection, so the user cannot accidentally edit the content. Finally, as B\+N\+A may harvest from and provide config to many fabrics at once, this is typically \char`\"{}a broader net to cast\char`\"{} to collect information. \section{Cisco \char`\"{}show device-\/alias database\char`\"{}}\label{DeviceAliasParser}
